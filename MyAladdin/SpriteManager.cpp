...
SpriteManager::SpriteManager(const char * filePath, D3DCOLOR transcolor, vector<Rect*> listSourceRect, bool autoUpdate)
{
	HRESULT result;
...
SpriteManager::SpriteManager(LPDIRECT3DTEXTURE9 texture, vector<Rect*> listSourceRect, bool autoUpdate)
{
	this->mPosition = D3DXVECTOR3(0, 0, 0);
	this->mRotation = 0;
	this->mRotationCenter = D3DXVECTOR2(mPosition.x, mPosition.y);
...
void SpriteManager::UpdateFrame()
{
	this->mCurrentFrame = (this->mCurrentFrame + 1) % this->mCountFrame;
}
