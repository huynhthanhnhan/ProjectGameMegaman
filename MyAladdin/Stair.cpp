...
Collision::ResultCollision Stair::processCollision(Object * obj)
{
	...
	D3DXVECTOR2 intersectionPoint = this->getIntersectionPoint(this->_equation, this->getEquation(objectCurrentLocation, objectNextLocation));
	...
	if (this->getEquationValue(objectNextLocation) <= 0)
	{
		...
		case Global::ALADDIN:
		{
			...
			x = (x < this->_x) ? this->_x : x;
			x = (x > this->_x + this->_width) ? this->_x + this->_width : x;
