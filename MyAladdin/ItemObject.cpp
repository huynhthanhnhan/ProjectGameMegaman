...
Collision::ResultCollision ItemObject::processCollision(Object * obj)
{
	...
	WRect rectBody;
	if (Aladdin::getInstance()->IsHit())
		rectBody = Aladdin::getInstance()->getRectSword();
	else
...
void ItemObject::Render(D3DXVECTOR3 position, D3DXVECTOR2 scale, D3DXVECTOR2 translation, float rotation, D3DXVECTOR2 rotationCenter)
{
	...
	case Global::HitStand:this->mListSprite[_state]->Draw(-1, position, _rect, scale, translation, rotation, rotationCenter); break;
	case Global::Attack:
	{
		this->mListSprite[Global::Run]->Draw(-1, position, _rect, scale, translation, rotation, rotationCenter);
		this->mListSprite[Global::Stand]->Draw(-1, position, _rect2, scale, translation, rotation, rotationCenter); 
		break;
	}
	default:
	{
