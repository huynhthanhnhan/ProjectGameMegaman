...
Collision::ResultCollision Platform::processCollision(Object * obj)
{
	WRect rect1;
...
void Platform::update(float detalTime)
{
	StaticObject::Instance()->addPlatform(this);
}
