...
Column::Column(int x, int y, int width, int height)
	:Object(x, y, width, height)
{
	this->_type = Global::Static;
	this->_rectBound.update(x, y, width, height);
	this->_vx = 0;
	this->_vy = 0;
	this->_id = Global::COLUMN;
}
...
Collision::ResultCollision Column::processCollision(Object * obj)
{
	WRect rect1;
...
void Column::update(float detalTime)
{
	StaticObject::Instance()->addColumn(this);
}
