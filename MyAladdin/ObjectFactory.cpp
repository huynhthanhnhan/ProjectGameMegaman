...
Object * ObjectFactory::createObject(Global::EObject id, int x, int y, int width, int height, Global::EDirection direct)
{
	...
	case Global::GROUND_DROP: obj = new ActionGround(x, y, width, height); break;
	case Global::ROPE: obj = new Rope(x, y, width, height);  break;
	case Global::COLUMN: obj = new Column(x, y, width, height);  break;
	...
	case Global::MONKEYITEM: obj = new AbuItem(x, y); break;
	case Global::JAFAR: obj = new Jafar(x, y, width, height, direct); break;
	case Global::PLATFORM: obj = new Platform(x, y, width, height); break;
	case Global::PEDDLER: obj = new Peddler(x, y); break;
	case Global::FIRE: obj = new FireBurning(x, y, width, height, direct); break;
	case Global::NOTORBANGER: obj = new Notorbanger(x, y, width, height, direct); break;
	case Global::GUNNER: obj = new HeadGunner(x, y, width, height, direct); break;
	case Global::HELIT: obj = new Helit(x, y, width, height, direct); break;
	}
	return obj;
}
